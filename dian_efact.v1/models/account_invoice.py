            ...
            for invoice in self:
                ...
                for item in items:
                    ...
                    if iva_01 == 0:
                        item_tributo = {
                                "codigo": '01',
                                "porcentaje": abs(float(0)),
                                "montoAfectacionTributo": abs(float(0)),
                                "total_venta": subTotalVenta
                            }
                        item_tributos.append(item_tributo)
                    if ica_03 == 0:
...
#                     *************+*****
                ...
                secuencia_consecutivo = '0001' + str(secuencia_consecutivo)
                ...
                dian_data = {
                    ...
                    "emisor": {
                        ...
                        "vat_dv": invoice.company_id.partner_id.l10n_co_verification_code,
                    ...
                    "receptor": {
                        ...
                        "vat_dv": invoice.partner_id.l10n_co_verification_code,
